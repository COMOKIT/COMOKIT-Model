...
experiment "Comparison"  parent: abstract_experiment autorun: true {
	...
	action _init_ {
		 ...
		 */		
		create simulation with:(name: "No Containment", seed:simulation_seed ){
			name <- "No Containment";
			ask Authority { 
		 ...
		 */	
		create simulation with:(name: "Home Containment",seed:simulation_seed ){
		 ...
		 */		
		create simulation  with:(name: "School closed", seed:simulation_seed ) {
			name <- "School closed";
			ask Authority {
