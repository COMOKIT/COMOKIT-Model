...
global {
	...
	string shp_boundary_path <- dataset + "/generated/boundary.shp";
	
	//Population data 
	string csv_building_type_weights_path <- (dataset+"/Building type weights.csv") ;
		
	
	string csv_activity_weights_path <- (dataset+"/Activity weights.csv") ;
