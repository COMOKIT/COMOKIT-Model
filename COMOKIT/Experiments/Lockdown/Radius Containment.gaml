...
* 		initially, a local lockdown is decided around an infected Individual (i.e. in a circle of a given radius, no activity is allowed).
...
* Parameters:
* 	- tolerance: defines the rate of the population who it allowed to do its activities. (default value: 0.2)
